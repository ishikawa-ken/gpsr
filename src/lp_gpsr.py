...
class GPSR_data(object):
    def __init__(self):
        ...
        os.getlogin()
        f = open("/home/" + os.getlogin() + "/catkin_ws/src/gpsr/resource/Category1.txt")
        datas = f.read()
        f.close()
    ...
    def _GetNamesData_(self):
        path = os.path.abspath("/home/" + os.getlogin() + "/catkin_ws/src/gpsr/resource/GPSRCmdGen-2018-Montreal/CommonFiles")
